...
public static class PreviewApp
{
    ...
    public static int Run()
    {
        ...
        var window = new Window
        {
            ...
            Width = 380,
            Height = 720,
            Background = PanelChrome.DefaultDark.Background,
        };

        var chrome = PanelChrome.DefaultDark;
        var panel = new PanelView(chrome);
        ...
        void Show(int i)
        {
            ...
            window.Title = $"git review preview — {name}";
        ...
        var next = new System.Windows.Controls.Button { Content = "Next ▶", Padding = new Thickness(8, 4, 8, 4) };
